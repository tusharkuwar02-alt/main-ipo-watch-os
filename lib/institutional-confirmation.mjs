...
export function parseInstitutionalHoldingsXbrl(xml) {
  ...
  let mfPct = null, fpiPct = null, fallbackFpiPct = null;
  ...
  if (mfPct == null && fpiPct == null && fallbackFpiPct == null) return null;
  return { mfPct: mfPct ?? 0, fpiPct: fpiPct ?? fallbackFpiPct ?? 0 };
}
